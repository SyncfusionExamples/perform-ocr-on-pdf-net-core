# OCR Process PDF Document in Azure App Service
The [Syncfusion .NET OCR processor library](https://www.syncfusion.com/document-processing/pdf-framework/net/pdf-library/ocr-process) has extended support to OCR process PDF documents and other scanned images in the .NET Core platform. This repository contains examples to perform OCR on PDF document in ASP.NET Core Web Application and Azure App Service using Syncfusion .NET OCR library.

Sample name | Description
--- | ---
[Perform OCR on PDF document in Azure App Service](https://github.com/SyncfusionExamples/perform-ocr-on-pdf-net-core/blob/master/Perform_OCR_NET_Core) | Perform OCR processing on PDF documents in Azure App Service.
